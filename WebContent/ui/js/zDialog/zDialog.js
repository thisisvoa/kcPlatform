 ...
 * 标志弹出框已改变
 */
Dialog.prototype.markUpdated = function(){
	this.isUpdate = true;
};
 ...
 * 标志弹出框的改变取消
 */
Dialog.prototype.cancelUpdated = function(){
	this.isUpdate = false;
};
...
Dialog.prototype.getData = function(data){
	return this.data;
};
...
Dialog.prototype.create = function () {
  ...
  <table id="_DialogTable_' + this.ID + '" width="' + (this.Width + 26) + '" cellspacing="0" cellpadding="0" border="0" onselectstart="return false;" style="-moz-user-select: none; font-size:12px; line-height:1.4;">\
    <tr id="_Draghandle_' + this.ID + '" style="' + (this.Drag ? "cursor: move;" : "") + '">\
      <td width="13" height="33" class="dialog_top_left"><div style="width: 13px;"></div></td>\
      <td height="33" class="dialog_top_center"><div style="padding: 9px 0 0 4px; float: left; font-weight: bold; color:#fff;"><span style="" class="dialog_icon"></span><span id="_Title_' + this.ID + '">' + this.Title + '</span></div>\
        <div onclick="Dialog.getInstance(\'' + this.ID + '\').cancelButton.onclick.apply(Dialog.getInstance(\'' + this.ID + '\').cancelButton,[]);" onmouseout="this.className=\'dialog_closebtn\';" onmouseover="this.className=\'dialog_closebtn_over\';" style="'+ (this.ShowCloseButton ? "" : "display:none;") +'" class="dialog_closebtn"></div></td>\
      <td width="13" height="33" class="dialog_top_right" href="#;"></a></div></td>\
    </tr>\
    <tr valign="top">\
      <td width="13" class="dialog_middle_left"></td>\
      <td align="center"><table width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#ffffff">\
          <tr id="_MessageRow_' + this.ID + '" style="' + (this.ShowMessageRow ? "" : "display:none") + '">\
            <td valign="top" height="50"><table width="100%" cellspacing="0" cellpadding="0" border="0" class="message_dialog_bg" id="_MessageTable_' + this.ID + '">\
                <tr>\
                  <td width="50" height="50" align="center"><div style="width:32px;height:32px" class="'+(this.MessageIcon==""?"default_messageIcon":+this.MessageIcon)+'" id="_MessageIcon_' + this.ID + '"/></td>\
        ...
        return "";
          ...
          <tr id="_ButtonRow_' + this.ID + '" style="' + (this.ShowButtonRow ? "" : "display:none") + '">\
            <td height="36"><div id="_DialogButtons_' + this.ID + '" style="border-top: 1px solid #DADEE5; padding: 8px 20px; text-align: right; background-color:#f6f6f6;">\
                <input type="button" class="dialog-button" value="确 定" id="_ButtonOK_' + this.ID + '"/>\
                <input type="button" class="dialog-button" value="取 消" onclick="Dialog.getInstance(\'' + this.ID + '\').close();" id="_ButtonCancel_' + this.ID + '"/>\
              </div></td>\
          </tr>\
        </table></td>\
      <td width="13" class="dialog_middle_right"></td>\
    </tr>\
    <tr>\
      <td width="13" height="13" class="dialog_bottom_left"></td>\
      <td class="dialog_bottom_middle"></td>\
      <td width="13" height="13" class="dialog_bottom_right"><a onfocus=\'$id("_forTab_' + this.ID + '").focus();\' href="#;"></a></td>\
    </tr>\
  </table>\
</div>\
';
    ...
    $(".dialog-button").addClass("ui_button");
    $(".dialog-button").hover(function(){
    	$(this).addClass("ui_button_hover");
    },function(){
    	$(this).removeClass("ui_button_hover");
    });
	div=null;
};
...
Dialog.alert = function (msg, func, w, h) {
    ...
    diag.InnerHtml = '<table height="100%" border="0" align="center" cellpadding="10" cellspacing="0">\
		<tr><td align="right"><div id="Icon_' + this.ID + '" class="alert_icon"></div></td>\
...
Dialog.confirm = function (msg, funcOK, funcCal, w, h) {
    ...
    diag.InnerHtml = '<table height="100%" border="0" align="center" cellpadding="10" cellspacing="0">\
		<tr><td align="right"><div id="Icon_' + this.ID + '" class="query_icon"></td>\
			<td align="left" id="Message_' + this.ID + '" style="font-size:9pt">' + msg + '</td></tr>\
	</table>';
    diag.show();
    diag.okButton.parentNode.style.textAlign = "center";
