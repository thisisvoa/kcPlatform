...
(function () {
    ...
    var iframeUrlMap = {
       ...
       //'highlightcode':'~/dialogs/highlightcode/highlightcode.html',
        ...
        'hiddeninput':'~/dialogs/hiddeninput/hiddeninput.html'
    };
    ...
    var btnCmds = ['undo', 'redo', 'formatmatch',
        ...
        'hiddeninput','textinput','datepicker','textarea','checkbox','radiobox','combobox','combotree','userselector','orgselector','roleselector'];
    ...
    var dialogBtns = {
        ...
        ok:['attachment', 'anchor', 'link', 'insertimage', 'map', 'gmap', 'insertframe', 'wordimage',
            'insertvideo', 'insertframe', 'edittip', 'edittable', 'edittd', 'scrawl', 'template', 'music', 'background','hiddeninput']
