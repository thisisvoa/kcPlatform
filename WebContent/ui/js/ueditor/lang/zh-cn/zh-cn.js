...
UE.I18N['zh-cn'] = {
    'labelMap':{
        ...
        'hiddeninput':'隐藏域','textinput':'单行文本框','datepicker':'日期选择器','textarea':'多行文本框','checkbox':'复选框','radiobox':'单选框','combobox':'下拉框','combotree':'下拉树',
        'userselector':'用户选择器','orgselector':'单位选择器','roleselector':'角色选择器'
    },
    'insertorderedlist':{
        'num':'1,2,3...',
        'num1':'1),2),3)...',
