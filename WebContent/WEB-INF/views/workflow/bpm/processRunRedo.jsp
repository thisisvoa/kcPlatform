...
function doSave(){
	if($("#editForm").validate("validate")){
		MessageUtil.confirm("是否确认召回？",function(){
			var data = $("#editForm").serialize();
			$.postc("${ctx}/workflow/bpm/processRun/redo.html",data, function(){
...
<ui:LayoutContainer fit="true">
	<ui:Layout region="north" style="height:33px">
		<div id="toolbar" class="easyui-toolbar" style="width: 100%;">
			<a id="saveBtn" href="#" iconCls="icon-rejectToStart" onclick="doSave()">召回</a>
