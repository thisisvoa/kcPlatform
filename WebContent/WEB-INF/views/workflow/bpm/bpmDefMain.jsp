...
<script type="text/javascript">
	...
	function addBpmCatalog(){
		...
		topWin.Dialog.open({
			Title : "新增流程分类",
			URL : '${ctx}/workflow/bpmCatalog/toAdd.html?catalogType=1&parentId='+node.id,
			Width : 500,
			Height : 250,
	...
	$parsed(function(){
		$("#ws").layout("panel","center").panel("body").html("<iframe id=\"processDefFrame\" name=\"processDefFrame\" style=\"width:100%;height:100%;\" "+
			"src=\"${ctx}/workflow/bpmDef/tolist.html\" frameBorder=0 style=\"padding:0px;margin:0px\" ></iframe>");
	});
</script>
</head>
<body>
	<ui:LayoutContainer fit="true" id="ws">
		...
		<ui:Layout region="center" title="流程定义管理">
		</ui:Layout>
	</ui:LayoutContainer>
