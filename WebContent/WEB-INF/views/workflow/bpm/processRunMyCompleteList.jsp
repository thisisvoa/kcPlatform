...
<ui:LayoutContainer fit="true">
	...
	<ui:Layout region="center">
		<ui:Grid id="taskList" datatype="json" shrinkToFit="false" fit="true" viewrecords="true" pageable="true" 
			url="${ctx}/workflow/bpm/processRun/myCompleteList.html" multiselect="false"
			...
			<ui:Column header="持续时间" name="duration" width="130" formatter="durTimeFormatter"></ui:Column>
