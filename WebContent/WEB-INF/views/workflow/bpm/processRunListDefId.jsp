...
<ui:LayoutContainer fit="true">
	<ui:Layout region="north" style="height:105px;">
		...
		<table class="formTable">
			<tr>
				<td class="label" style="width: 100px">流程实例名称：</td>
	...
	<ui:Layout region="center">
		<ui:Grid id="processRunList" datatype="json" shrinkToFit="false"
			...
			url="${ctx}/workflow/bpm/processRun/list.html?defId=${defId}" multiselect="true"
			...
			<ui:Column header="流程实例名称" name="subject" width="200" formatter="subjectFormatter"></ui:Column>
