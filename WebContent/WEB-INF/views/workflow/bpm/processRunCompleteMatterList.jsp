...
<ui:LayoutContainer fit="true">
	<ui:Layout region="north" style="height:100px" border="false">
		...
		<table class="formTable">
			...
			<tr>
				...
				<td style="width: 130px">
					<select id="status" name="status" class="easyui-combobox" dropdownHeight="75">
	...
	<ui:Layout region="center">
		<ui:Grid id="taskList" datatype="json" shrinkToFit="false" fit="true" viewrecords="true" pageable="true" 
			url="${ctx}/workflow/bpm/processRun/completeMatterList.html" multiselect="false"
			...
			<ui:Column header="持续时间" name="duration" width="90" formatter="durTimeFormatter"></ui:Column>
