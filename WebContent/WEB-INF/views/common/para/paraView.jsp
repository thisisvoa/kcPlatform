...
<body>
	<table class="tableView">
		...
		<tr>
			<td class="label" style="width:120px">参数名称：</td>
			<td>${para.csmc}</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><c:if test="${para.sybz == '0'}">
					<span class="text" style="color: red;">禁用</span>
				</c:if>
				<c:if test="${para.sybz == '1'}">
		...
		<tr>
			...
			<td>
			<textarea name="bz" class="easyui-textarea" readonly="readonly" style="width:470px;height:180px" >${para.bz}</textarea>
			</td>
		</tr>
	</table>
</body>
