...
<script type="text/javascript">
	function save(){
		...
		MessageUtil.confirm("确定将选择的角色分配给用户[${user.yhmc}]吗？",function(){
			$.postc("${ctx}/userRole/assignRoleToUser.html",{userId: $("#userId").val(), roles:checkRoles},
					function (data){
						MessageUtil.show('成功为用户分配角色！');
					}
			);
		});
...
<body style="padding:1px;">
	<ui:LayoutContainer fit="true">
			...
			<ui:LayoutContainer fit="true">
				...
				<ui:Layout region="center" style="padding-top:2px;padding-right:1px" border="false">
					<ui:Grid id="roleList" datatype="json" shrinkToFit="true" fit="true" viewrecords="true" pageable="true"
						...
						rowNum="20" rowList="[10,20,50]" onSelectRow="onSelectRow" 
						gridComplete="roleListGridComplete" onSelectAll="onSelectAll">
		...
		<ui:Layout region="east" style="width:200px;padding-top:2px;padding-left:1px" split="true" title="已分配角色">
			<ui:Grid id="assignedRoleList" datatype="json" shrinkToFit="true" fit="true" viewrecords="true" pageable="false"
						url="${ctx}/userRole/getAssignedRoleList.html?userId=${user.zjid}" rownumbers="false"
