...
<script>
	...
	function save(){
		...
		MessageUtil.confirm("确定将选择的单位分配给[${role.jsmc}]吗？",function(){
			$.post("${ctx}/orgRole/assignOrgToRole.html",{roleId: $("#roleId").val(), orgs:orgStr},
					function (data){
						MessageUtil.show('成功为角色分配单位！');
					}
			);	
		});
	}
						...
						<fieldset style="width:98%;height:95%;"> 
							...
							<div style="width:100%;height:95%;">
								<ui:Grid id="assignedOrgList" datatype="json" shrinkToFit="true" fit="true" rowNum="999"
									url="${ctx}/orgRole/getAssignedOrgList.html?roleId=${role.zjid}" gridComplete="onGridComplete" loadComplete="loadComplete">
