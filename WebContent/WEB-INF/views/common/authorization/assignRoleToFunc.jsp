...
<script type="text/javascript">
	...
	function save(){
		...
		MessageUtil.confirm("确定将选择的角色分配给[${func.gnmc}]吗？",function(){
			$.postc("${ctx}/roleFunc/assignRoleToFunc.html",{funcId: $("#funcId").val(), roles:checkRoles},
					function (data){
						MessageUtil.show('成功为功能分配角色！');
					}
			);
		});
	}
...
<ui:LayoutContainer fit="true">
		...
		<ui:Layout region="east" style="width:200px;padding-top:2px;padding-left:1px" split="true" title="已分配角色">
			<ui:Grid id="assignedRoleList" datatype="json" shrinkToFit="true" fit="true" pageable="false"
						url="${ctx}/roleFunc/getAssignedRoleList.html?funcId=${func.zjId}" rownumbers="false"
