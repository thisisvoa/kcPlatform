...
public class ProcessDiagramCanvas {
  ...
  protected static Color POOL_BOUNDARY_COLOR = new Color(138, 140, 142);
  protected static Color LANE_BOUNDARY_COLOR = new Color(138, 140, 142);
  protected static Color POOL_BACKGROUP_COLOR = new Color(211, 215, 212);
  protected static Color LANE_BACKGROUP_COLOR = new Color(211, 215, 212);
  ...
  public void drawHPool(String name, int x, int y, int width, int height) {
     ...
     AffineTransform newAffineTransform = AffineTransform.getRotateInstance(-1.570796326794897D, textX, textY);
   ...
   {
	 g.setFont(new Font("宋体", Font.BOLD, 11));
