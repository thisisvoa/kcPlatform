...
public class DivShape extends Shape
{
  ...
  {
    return "<div class='flowNode' id='" + this.id + "' " + "style='position:absolute;z-index:" + this.zIndex + "; " + "left:" + getX() + "px;" + "top:" + getY() + "px;" + "width:" + getW() + "px;" + "height:" + getH() + "px;' " + "title='" + getName() + "' " + "type='" + getType() + "'></div>\r\n".replaceAll("\\.0px", "px");
  }
}
