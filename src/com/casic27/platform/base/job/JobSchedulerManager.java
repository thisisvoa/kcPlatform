...
import com.casic27.platform.base.job.constant.JobConstants;
import com.casic27.platform.base.job.core.JobRunLogger;
 ...
 * 拥有和任务匹配的触发器，如果{@link com.casic27.platform.base.job.BindTrigger#isTopPriority()}返回<code>true</code>，则使用任务自带的触发器，否则使用
...
public class JobSchedulerManager {
    ...
    private void loadJobs() {
        List<com.casic27.platform.base.job.entity.Job> jobs = jobService.getReleasedJobs();
        for (com.casic27.platform.base.job.entity.Job job : jobs) {
    ...
    public void executeJobCommand() {
        ...
        for (JobCommand jobCommand : jobCommands) {
        	com.casic27.platform.base.job.entity.Job job = jobService.getJobByFullName(jobCommand.getJobGroupName(), jobCommand.getJobName());
