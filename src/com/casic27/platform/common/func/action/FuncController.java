 ...
 *—————————————————————————————————————
 */
package com.casic27.platform.common.func.action;
...
public class FuncController extends BaseMultiActionController{
	...
	public @ResponseBody GridData funcListData(HttpServletRequest request){
		...
		String belongMenu = com.casic27.platform.util.StringUtils.getNullBlankStr(getURLDecode(request.getParameter("belongMenu")));
		String funName = com.casic27.platform.util.StringUtils.getNullBlankStr(getURLDecode(request.getParameter("funName")));
		String useFlag = com.casic27.platform.util.StringUtils.getNullBlankStr(getURLDecode(request.getParameter("useFlag")));
		String id = com.casic27.platform.util.StringUtils.getNullBlankStr(getURLDecode(request.getParameter("id")));
		funcMap.setCdxxCdmc(com.casic27.platform.util.StringUtils.escapeSqlLike(belongMenu));
		funcMap.setGnmc(com.casic27.platform.util.StringUtils.escapeSqlLike(funName));
