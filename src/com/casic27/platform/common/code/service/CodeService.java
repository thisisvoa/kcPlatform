/**
 * @(#)com.casic27.platform.common.code.service.CodeService.java
 ...
 *—————————————————————————————————————
 */
package com.casic27.platform.common.code.service;
...
import com.casic27.platform.common.code.dao.ICodeMapper;
import com.casic27.platform.common.code.entity.Code;
