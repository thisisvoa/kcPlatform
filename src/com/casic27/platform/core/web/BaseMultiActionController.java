/**
 * @(#)com.casic27.platform.core.web.BaseMultiActionController.java
 ...
 *—————————————————————————————————————
 */
package com.casic27.platform.core.web;
...
import com.casic27.platform.core.exception.ResponseError;
