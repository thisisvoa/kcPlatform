package com.kcp.platform.base.job.web;
...
import com.kcp.platform.base.job.core.JobSchedulerRecognizer;
...
public class ServerHostRecognizer extends BaseMultiActionController {
    ...
    /**
     * 受理{@link com.kcp.platform.base.job.core.JobSchedulerRecognizer}发送的任务调度服务器识别的请求，解析出
     * 本任务调度服务器的地址（IP和端口）.
     *
     * @param request
     * @param response
