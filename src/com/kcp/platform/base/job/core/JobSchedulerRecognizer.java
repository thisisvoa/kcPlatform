package com.kcp.platform.base.job.core;
...
import com.kcp.platform.base.job.AbstractTriggerBeanJob;
import com.kcp.platform.base.job.JobSchedulerManager;
import com.kcp.platform.base.job.entity.JobScheduler;
import com.kcp.platform.base.job.service.JobSchedulerService;


/**
 * 任务调度服务识别器。JobSchedulerRecognizer定时运行，获取{@link com.kcp.platform.base.job.entity.JobScheduler}列表，
 * 然后向{@link com.kcp.platform.base.job.entity.JobScheduler}列表所指定的服务发送请求，请求受理者为目标服务器上的
 * {@link com.kcp.platform.base.job.web.ServerHostRecognizer}。当接收到请求后，即可分析目标服务器的服务的地址，并设置
