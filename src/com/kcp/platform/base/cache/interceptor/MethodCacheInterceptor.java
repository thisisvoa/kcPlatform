...
import com.kcp.platform.base.cache.annotation.CacheAnnotationParser;
import com.kcp.platform.base.cache.annotation.SimpleCachingAnnotationParser;
import com.kcp.platform.base.cache.itemmanager.CacheItemManager;
...
public class MethodCacheInterceptor {
	 ...
	 */
	@Around(value="@annotation(com.kcp.platform.base.cache.annotation.Cacheable)")
	 ...
	 */
	@Around(value="@annotation(com.kcp.platform.base.cache.annotation.CacheEvict)")
